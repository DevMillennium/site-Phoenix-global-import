...
const linkCotacao = getWhatsAppLink("Olá! Gostaria de solicitar cotação para o seguinte produto: ");
        ...
        <section className="mt-10 space-y-10" id="cotacao" aria-labelledby="cotacao-heading">
          <div>
            ...
            <a
              ...
              aria-label="Abrir WhatsApp para solicitar cotação"
              data-track-event="contato_whatsapp_click"
              data-track-payload='{"source":"contato_page","action":"abrir_whatsapp_cotacao"}'
            >
          ...
          <div className="rounded-xl border border-phoenix-border bg-phoenix-card p-6">
            ...
            <a
              ...
              data-track-event="contato_whatsapp_click"
              data-track-payload='{"source":"contato_page","action":"abrir_whatsapp_atendimento"}'
            >
