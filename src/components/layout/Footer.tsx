        ...
        <div className="grid gap-8 sm:gap-10 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <a
              ...
              className="inline-flex items-center justify-center min-h-touch gap-2 rounded-lg bg-phoenix-success/20 px-4 py-3 text-sm font-medium text-emerald-300 hover:bg-phoenix-success/30 transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-phoenix-primary touch-manipulation"
            ...
            <div className="mt-3 flex gap-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center min-h-touch min-w-touch rounded-lg text-phoenix-text-muted hover:text-phoenix-primary transition-colors touch-manipulation"
