        ...
        <div>
          ...
          {isOutOfStock ? (
            ...
            <div className="mt-6 sm:mt-8 flex flex-wrap gap-3">
              ...
              <LinkInstagram
                className="inline-flex items-center justify-center min-h-touch gap-2 rounded-lg border border-phoenix-border px-5 py-3 sm:px-6 font-medium text-phoenix-text-muted hover:text-phoenix-text hover:border-pink-500/40 transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-phoenix-primary touch-manipulation cursor-pointer text-sm"
                ariaLabel={`Chamar no Instagram sobre ${product.name}`}
                trackingSource="pdp"
                trackingAction="instagram_direct_produto"
                leadContext={{
                  ...leadBase,
                  intent: "product_interest",
                  message: buildInstagramDirectMessage(product, "product_interest"),
                }}
              >
                <svg className="h-5 w-5 shrink-0" fill="currentColor" viewBox="0 0 24 24" aria-hidden>
